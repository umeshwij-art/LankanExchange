      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            {/* Hero Section */}
            <div id="main-chart" className="bg-card text-card-foreground border border-border rounded-xl p-10 relative overflow-hidden">
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  <Badge variant="outline" className="bg-primary/10 text-primary border-primary/20 text-[10px] font-bold uppercase tracking-widest">
                    Live Market Pulse
                  </Badge>
                ...
                <div className="max-w-2xl relative">
                  ...
                  <Input 
                    ...
                    className="h-12 pl-12 pr-12 text-base rounded-lg border-border bg-muted/50 text-foreground placeholder:text-muted-foreground focus-visible:ring-primary/20 focus-visible:border-primary/30 transition-all"
                    value={searchQuery}
